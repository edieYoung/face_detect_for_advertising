...
- (void)viewDidLoad {
    ...
    self.dataArray = @[@[@{@"title" : @"评价视频一",@"selector" : @"ad1Face"},
                         @{@"title" : @"评价视频二",@"selector" : @"ad2Face"},
                         @{@"title" : @"评价视频三",@"selector" : @"ad3Face"},
                         @{@"title" : @"评价视频四",@"selector" : @"ad4Face"}],];
  
//                        @[@{@"title" : @"人脸检测",@"selector" : @"detectFace"},
...
- (void)ad1Face{
    ...
    detectVC.adName = @"snack";
    [self.navigationController pushViewController:detectVC animated:YES];
}

- (void)ad2Face{
    EDCardViewController *detectVC = [[EDCardViewController alloc] init];
    detectVC.adName = @"ikea";
    [self.navigationController pushViewController:detectVC animated:YES];
}

- (void)ad3Face{
    EDCardViewController *detectVC = [[EDCardViewController alloc] init];
    detectVC.adName = @"cosm";
    [self.navigationController pushViewController:detectVC animated:YES];
}

- (void)ad4Face{
    EDCardViewController *detectVC = [[EDCardViewController alloc] init];
    detectVC.adName = @"lancome";
    [self.navigationController pushViewController:detectVC animated:YES];
}
